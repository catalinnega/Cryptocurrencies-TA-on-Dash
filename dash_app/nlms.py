...
def get_graph(**kwargs):
        ...
        v = kwargs['volume']
        error = kwargs['error']
        #error_diff = kwargs['error_diff']
        filter_output = kwargs['filter_output']
        ...
        go.Scatter(
                        x=list(ts_ochlv),
                        y=list(filter_output),
                        name='NLMS filter output',
                        visible=True,
        ...
        fig.update_layout(
                        ...
                        title_text="Normalized Least Mean Squares",
        ...
        fig.update_yaxes(
                title_text="NLMS error",
                range=[min(error), max(error)], 
                row = 2,
                col = 1,
                showgrid = False,
                showspikes = True,
